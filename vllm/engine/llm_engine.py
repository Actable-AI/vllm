...
class LLMEngine:
    ...
    def __init__(
        ...
        logger.info(
            ...
            f"self-extend={model_config.self_extend}, "
            f"self-extend-group-size-1={model_config.self_extend_group_size_1}, "
            f"self-extend-group-size-2={model_config.self_extend_group_size_2}), "
        )
