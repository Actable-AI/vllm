...
class ModelConfig:
    ...
    Args:
        ...
        max_context_len_to_capture: Maximum context len covered by CUDA graphs.
            ...
            to eager mode.
        self_extend: Whether to use self-extend mode. If True, we will use the
            self-extend mode, which can extend the maximum context length of the model
            (only available for Llama-based models).
        self_extend_group_size_1: Value of group_size_1 if self_extend is enabled.
        self_extend_group_size_2: Value of group_size_2 if self_extend is enabled.
    """
    ...
    def __init__(
        ...
        self_extend_group_size_1: int = 8,
        self_extend_group_size_2: int = 1024,
    ) -> None:
        self.model = model
        ...
        self.self_extend_group_size_1 = self_extend_group_size_1
        self.self_extend_group_size_2 = self_extend_group_size_2
